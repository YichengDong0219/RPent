...
如果要用已有的开源多模态 Qwen3.5 服务替代托管 planner，请运行
`/home/dongyicheng/set_qwen9b.sh`，再用 `scripts/qwen_vl/check_server.py`
联调，然后选择 `--planner api --model qwen-vl:Qwen3.5-9B`。4B/9B 的
端口映射和 GPU 注意事项见上面的规划器文档。
